...
function openPopup(){
    ...
    // popup.className 써보자
    // 클래스 구분을 줘야하기 때문에 ' is-active' 앞에 한칸 띄워줬다.
    // popup.className = popup.className + " is-active";
    // 메소드
    // popup.classList.add("is-active");
    // 와 메소드 편하네

    // 조건문으로 해보자. 클래스가 있는지 확인을 하고 있으면 붙히지말고 없으면 붙히자
    // popup.classList.contatins("is-active") : is-active 클래스가 있는지 확인
    //
    // 문자열 버전
    ...
    // 메소드 사용해서 조건 추가
    if(popup.classList.contains("is-active")){
        // is-active가 있으면 제거할거임 ㅎㅎ
        // remove : 클래스 제거 메소드
        popup.classList.remove("is-active");
    }else{
        // is-active가 없으면 추가할거임
        // add : 클래스 추가 메소드
        popup.classList.add("is-active");
    }
}