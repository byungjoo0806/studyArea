...
function createCookie(name, value, time){
    ...
    // 생성자로 구현이 가능하다. new로 생성해주는데, 뭘 생성해줘야하나
    // date
    ...
    // 날짜 형태를 'Wed, 22 Mar 2023 04:46:55 GMT' 이런식으로 변경
...
// 다들 정규식은 간단한 것만 사용하고 필요한 내용이 생기면 찾고하면 편해서 찾아서 작성하는 경우가 많아
...
// window.localStorage.setItem("user_id","pbj");
